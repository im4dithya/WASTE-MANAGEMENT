...
class _forgototpsubState extends State<forgototpsub> {
  ...
  // Method to determine OTP box size based on screen width
  double _getOtpBoxSize(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    if (width < 350) return 45;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  if (_otpExpirySeconds >= 0)
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _isOtpExpired ? Colors.red[50] : Colors.green[50],
                                        borderRadius: BorderRadius.circular(12),
                                        border: Border.all(
                                          color: _isOtpExpired ? Colors.red[200]! : Colors.green[200]!,
                                        ),
                                      ),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Icon(
                                            ...
                                            color: _isOtpExpired ? Colors.red : Color(0xFF2E7D32),
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: List.generate(6, (index) {
                                                final boxSize = _getOtpBoxSize(context);
                                                return Container(
                                                  width: boxSize,
                                                  height: boxSize * 1.2,
                                                  decoration: BoxDecoration(
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: _isOtpExpired ? Colors.grey[400]! : Color(0xFF2E7D32),
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(12),
                                        ),
                                        elevation: 2,
                        ...
                        // Spacer at the bottom for better spacing on small screens
